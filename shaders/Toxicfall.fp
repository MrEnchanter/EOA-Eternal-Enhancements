...
void SetupMaterial(inout Material material)				
{
	...
	vec4 Normalmapbase = texture(normaltexture, GetNormalLiquidscrollnegAt(ParallaxMap)) * 0.3; 
	...
	vec4 Specbasecolor = vec4(0.30, 0.40, 0.20, 1.0);//RGBA Specbaselayercolor color
	vec4 Spectopcolor = vec4(0.20, 0.35, 0.20, 1.0);//RGBA Spectoplayercolor color 
